...
<head>
  ...
  <title>Humanitarna akcija</title>
  ...
  <style>
    ...
    .left-image {
      flex: 1;
      min-height: 300px;
      background-color: #ddd; /* Ovo možeš zamijeniti sa background-image kasnije */
      margin-right: 30px;
      border-radius: 10px;
    }
...
<div class="content-section">
  <div class="left-image">
    <img src="../img/ck-donacija.jpg" style="width: 100%; height: 100%; object-fit: cover;">
    <!-- Ovdje možeš postaviti <img src="tvoja_slika.jpg" style="width: 100%; height: 100%; object-fit: cover;"> -->
  </div>
  <div class="right-text">
    <h2>Humanitarna akcija pomoći</h2>
    <p>Crveni križ organizuje veliku humanitarnu akciju kako bi pružio pomoć osobama pogođenim nedavnim nepogodama. Pozivamo sve građane da se uključe i doprinesu svojim donacijama, volontiranjem i širenjem svijesti.</p>
    <p>Akcija će se sprovoditi u svim većim gradovima, a volonteri će biti prisutni na terenu kako bi prikupili potrebne artikle i pružili podršku ugroženima.</p>
  </div>
</div>
